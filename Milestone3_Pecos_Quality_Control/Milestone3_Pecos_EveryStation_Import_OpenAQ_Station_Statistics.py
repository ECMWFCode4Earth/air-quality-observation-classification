...
def Milestone3_Pecos_Complete_QualityControl_One_OpenAQStation(OpenAQStation, iteration_OpenAQStations):
...
# Results: Any measurement that has a larger increment or de increment by choosen value is an outlier
   ...
   OpenAQStation.plot(y='value', ylim=[1,100], figsize=(7.0,3.5))
   ...
   Report = 'test_results' + iteration_OpenAQStations + '.csv' 

   MonitoringReport = 'MonitoringReport' + iteration_OpenAQStations + '.html'
...
def Milestone3_Pecos_Quality_Control_EveryStation(OpenAQ_Stations):

   QC_Pecos_OpenAQ = []

   print(OpenAQ_Stations)
    
   for OpenAQStation in OpenAQ_Stations.iterrows():

      print(OpenAQStation) 
       
      OpenAQStation_Dataset = Milestone3_Get_Import_OpenAQ_Dataset_One_Staton(OpenAQStation)

      print(OpenAQStation_Dataset)

      QC_Pecos_OpenAQ_result = Milestone3_Pecos_Complete_QualityControl_One_OpenAQStation(OpenAQStation_Dataset, iteration1[iterationamount])
...
print("Getting OpenAQ dataset from ") 
print(dt_begin)
print(" to ")
print(dt_end)
print(" for every OpenAQ Station and parameter pm25")
...
QC_Pecos_OpenAQ_Results = Milestone3_Pecos_Quality_Control_EveryStation(OpenAQ_Stations)
