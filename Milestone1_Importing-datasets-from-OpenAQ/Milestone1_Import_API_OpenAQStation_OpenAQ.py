...
def Milestone1_Get_OpnenAQ_Dataset_Measurement_OpenAQStation_perStation(
    StationOpenAQ, parameter
):
...
def Milestone1_Get_Measurements_CSV_OpenAQStation(
    OpenAQ_Stations, SelectionOpenAQChoose, parameter, SelectionOpenAQ, dt_begin, dt_end
):
...
print(
    "Get the OpenAQ measurements for stations within raduis of chosen Coordinates from OpenAQ and doing Quality Control on it"
)
...
res2 = Milestone1_Get_OpnenAQ_Dataset_Measurement_OpenAQStation_perStation(
    OpenAQStation, parameter
)
...
Milestone1_Get_Measurements_CSV_OpenAQStation(
    res2, SelectionOpenAQChoose, parameter, SelectionOpenAQ, dt_begin, dt_end
)
